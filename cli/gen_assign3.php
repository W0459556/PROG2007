...
function generateAssignmentPDF($student_id, $student_name) {
    ...
    // Generate random data for this student
...
<ul>
    ...
    <li>Create function to initialize student records for $randRecords students via user input</li>
</ul>
...
// Get all students in the DB for PROG2007
